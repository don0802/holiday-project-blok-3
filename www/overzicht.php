...
<main>
    ...
    <div class="destinations">
        <?php foreach ($constructors as $constructor): ?>
            <a class="id" href="detailpagina.php?id=<?php echo $constructor['id']; ?>">
                <div class="destination-card">
                    <img src="https://picsum.photos/seed/<?php echo $constructor['thumbnail_name']; ?>/300/200">
                    <div class="destination-card-content">
                        <h2><?php echo $constructor['naam']; ?></h2>
                        <p><?php echo $constructor['beschrijving']; ?></p>
                        <div class="meta">
                            <span class="continent"><?php echo $constructor['continent']; ?></span>
                            <span class="land"><?php echo $constructor['land']; ?></span>
                            <span class="vakantietype"><?php echo $constructor['vakantietype']; ?></span>
                            <span class="prijs">€<?php echo $constructor['prijs']; ?></span>
                        </div>
                    </div>
                </div>
            </a>
